---
layout: page
title: EECS, University of California, Berkeley
permalink: /UCB/
description: A web page specially created to for EECS admission committee to aid my Ph.D. Application
nav: false
nav_order: 2
display_categories: [work,faculty_ucb]
horizontal: false
---
...
{%- if site.enable_project_categories and page.display_categories %}
  ...
  {%- assign category = page.display_categories[0] %}
...
{%- if site.enable_project_categories and page.display_categories %}
  <!-- Display categorized projects -->
  {%- assign category = page.display_categories[1] %}
  {%- assign categorized_projects = site.projects | where: "category", category -%}
  {%- assign sorted_projects = categorized_projects | sort: "importance" %}
  <!-- Generate cards for each project -->
  {% if page.horizontal -%}
